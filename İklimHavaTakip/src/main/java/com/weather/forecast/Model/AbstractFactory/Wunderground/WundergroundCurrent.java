...
public class WundergroundCurrent extends CurrentlyAttribute implements Services {
    ...
    public void getData() {
        ...
        wunderground.setUrl(Country,Province,null);
        wunderground.getCurrentlyData(this);
        showData();
    }
    @Override
