...
public class AccuweatherLong extends LongAtrribute implements Services {
    ...
    public void getData() {
        ...
        accuWeather.run(Day,Country,Province);
        accuWeather.getLongData(this);
        showData();
    }
